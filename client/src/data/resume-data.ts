...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    startDate: "Jan 2017",
    endDate: "Feb 2019",
    description: "Computer Software/Hardware/Network troubleshooting.",
    achievements: [
      "Provided technical support for software, hardware, and network issues",
      "Diagnosed and resolved complex technical problems for clients",
    ],
    techStack: "Software troubleshooting, Hardware diagnostics, Network configuration",
  },
  {
    company: "Deloitte",
    ...
    description: "Started as a support agent providing IT support to Deloitte colleagues. Went on to lead full-cycle workforce operations from recruitment to exit, ensuring seamless employee transitions and compliance with HR protocols.",
    achievements: [
      "Enhanced individual and team performance; assessed contributions and delivered constructive evaluations",
      "Elevated SLA compliance and customer satisfaction through implementation of quality standards",
      "Reduced resolution time and improved first contact resolution rates",
    ],
    techStack: "IT Support, Service Desk Management, Microsoft Office, HR Systems",
  },
];
